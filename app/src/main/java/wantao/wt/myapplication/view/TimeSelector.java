...
import wantao.wt.myapplication.utils.DateUtil;
import wantao.wt.myapplication.utils.ScreenUtil;
import wantao.wt.myapplication.utils.TextUtil;
...
public class TimeSelector {
    ...
    private final String ForMAT_STR1="MM-dd HH:mm";
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(DateUtil.format(selectedCalender.getTime(), ForMAT_STR1));
                seletorDialog.dismiss();
            }
        });
    ...
    private void loadComponent() {
        ...
        selectedCalender.set(year_pv.getSelected(),month_pv.getSelected()-1,day_pv.getSelected(),hour_pv.getSelected(),minute_pv.getSelected());
